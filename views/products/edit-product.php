...
if (isset($_POST["update_product"])){
    ...
    $result1 = updateProduct($id, $title, $category_id, $content, $keyword, $description, $price, $old_price, $json_array);
    if ($result1){
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="box-title">Update product №<?=$result["id"]?></h3>
                            </div>
                            <form method="post" role="form" data-toggle="validator">
                                <div class="card-body">
                                    <div class="form-group has-feedback">
                                        <label for="login">Title</label>
                                        <input class="form-control" name="title" id="title" type="text" value="<?=$result["title"]?>" required>
                                    ...
                                    <div class="form-group has-feedback col-sm-6">
                                        ...
                                        <select class="form-control" name="category_id" id="category_id">
                                            <?php foreach (getDataBYtable("productLines") as $item): ?>
                                                <option value="<?=$item['id']?>" <?php echo (isset($_GET['id']) && $item['id'] == $result["category_id"]) ? 'selected' : ""; ?>>
                                                    <?=$item['title']?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-7 has-feedback">
                                        ...
                                        <textarea class="form-control" name="content" id="content" rows="3" cols="15" required><?=$result["content"]?></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3">
                                            <div class="form-group has-feedback">
                                                ...
                                                <input class="form-control" name="keyword" id="keyword" type="text" value="<?=$result["keyword"]?>">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <label for="login">Description</label>
                                                <input class="form-control" name="description" id="description" type="text" value="<?=$result["description"]?>">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-md-3">
                                            <div class="form-group has-feedback">
                                                ...
                                                <input class="form-control" name="price" id="price" type="text" value="<?=$result["price"]?>" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <label for="login">Old Price</label>
                                                <input class="form-control" name="oldPrice" id="oldPrice" type="text" value="<?=$result["oldPrice"]?>">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" name="update_product">Обновить</button>
                                </div>
                            </form>
                        </div>
                    </div>
