                                        ...
                                        <ul class="pagination">
                                            <?php if ($previous_page > 0): ?>
                                                <li class="paginate_button page-item previous" id="example2_previous">
                                                    <a href="student-payments.php?page=<?=$previous_page; ?>" aria-controls="example2" data-dt-idx="0" tabindex="0" class="page-link" aria-label="Previous">
                                            ...
                                            <?php for ($i = 1; $i <= getPageCount("course"); $i++): $val_sort = $i; ?>
                                                ...
                                                <li class="paginate_button page-item <?php echo (isset($_GET["page"]) && $_GET["page"] == $i) ? 'active' : ''?>">
                                                    <a href="student-payments.php?page=<?=$val_sort;?>" aria-controls="example2" data-dt-idx="1" tabindex="0" class="page-link"><?=$i;?></a>
                                                </li>
                                            <?php endfor; ?>
                                            <?php if ($next_page <= getPageCount("course")):?>
                                                <li class="paginate_button page-item next" id="example2_next">
                                                    <a href="student-payments.php?page=<?=$next_page; ?>" aria-controls="example2" data-dt-idx="7" tabindex="0" class="page-link" aria-label="Next">
