...
if (isset($_POST["add_room"])){
    ...
    $result = addRoom($room, $roomNumber);
    if ($result){
        redirect('rooms.php');
    }
}
                            ...
                            <form method="post" id="quickForm" data-toggle="validator"> <!--role="form" novalidate="novalidate"-->
                                <div class="card-body">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" name="floor" id="floor" type="text" value="" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label for="lastName">Room number</label>
                                        <input class="form-control" name="roomNumber" id="roomNumber" type="text" value="" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-success" name="add_room">Добавить</button>
                                </div>
                            </form>
                        </div>
