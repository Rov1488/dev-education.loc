...
if(isset($_GET['id']) && isset($_GET["del"]) && !empty($_GET["del"]) == 'del-item'){
    $id = $_GET['id'];
    $del = $_GET["del"];
    $result = deleteData("invoice", $id, $del);
    if ($result){
        redirect('list-invoice.php');
    }
}
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="btn-group">
                    <p> <a href="add-invoice.php" class="left btn btn-block bg-gradient-success"><i class="fa fa-fw fa-plus"></i> </a></p>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                        ...
                                        <tr>
                                            <th>ID
                                                <?php if (!empty($s_type) &&  $s_type == 'asc'): ?>
                                                    <a href="list-invoice.php?sort=id,desc">
                                                        <i class="fas fa-sort-alpha-down-alt"></i>
                                                    </a>
                                                <?php elseif (!empty($s_type) &&  $s_type == 'desc'): ?>
                                                    <a href="list-invoice.php?sort=id,asc">
                                            ...
                                            <th>Student_id
                                                <?php if (!empty($s_type) &&  $s_type == 'asc'): ?>
                                                    <a href="list-invoice.php?sort=student_id,desc">
                                                        <i class="fas fa-sort-alpha-down-alt"></i>
                                                    </a>
                                                <?php elseif (!empty($s_type) &&  $s_type == 'desc'): ?>
                                                    <a href="list-invoice.php?sort=student_id,asc">
                                                        <i class="fas fa-sort-alpha-up-alt"></i>
                                                    </a>
                                                <?php else:?>
                                                    <a href="list-invoice.php?sort=student_id,asc">
                                        ...
                                        <tbody>
                                        <?php foreach (getListSort("invoice", $page, $order) as $item): ?>
                                            <tr class="odd">
