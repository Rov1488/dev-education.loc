...
if (isset($_POST["add_mentor"])){
    ...
    $result = addMentor($firstname, $lastname, $birthDate, $adress, $phone, $email, $workExp, $placeWork);
    if ($result){
                            ...
                            <form method="post" id="quickForm" data-toggle="validator"> <!--role="form" novalidate="novalidate"-->
                                <div class="card-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" name="work_experience" id="work_experience" type="text" value="" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label for="place_work">Place work</label>
                                        <input class="form-control" name="place_work" id="place_work" type="text" value="" required>
                                        <div class="help-block with-errors"></div>
                                    </div>

                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-success" name="add_mentor">Добавить</button>
                                </div>
                            </form>
                        </div>
